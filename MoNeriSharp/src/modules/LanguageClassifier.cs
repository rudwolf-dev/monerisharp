...
{
    /// <summary>
    /// Clasificador de idioma simple con TorchSharp.
    /// Entrena embeddings + LSTM + capa lineal.
    /// </summary>
    public class LanguageClassifier : Module
    {
        private Embedding embedding;
        private LSTM lstm;
        private Linear fc;

        public LanguageClassifier(string name, int vocabSize, int embedDim, int hiddenDim, int numLangs)
            : base(name)
        {
